            ...
            if ($(this).val() > 0) {
              ...
              if (flagResumen_Producto == true && flagDobeKeyUp == true) {
                ...
                "<div class='col s2 positionRelative imagenResumen'>"+
                  ...
                  "<div class='colorResumen "+Pro_Unico+" positionAbsolute bottom0 left0' style='background-color:"+Pro_Color+"'></div>"+
                "</div>"+
